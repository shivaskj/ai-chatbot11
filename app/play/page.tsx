...
export default function PromptTestingInterface() {
  ...
  return (
    ...
    // and a minimum height to fill the screen
      ...
      <div className="container mx-auto p-4 flex-1 flex flex-col md:px-20 lg:px-28 xl:px-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 flex-1 mb-3">
          ...
          <div className="bg-white rounded-lg shadow flex flex-col">
            ...
            <div className="p-3 flex justify-center  text-xs text-gray-500 mt-auto">
              <div className="flex items-center gap-2">
                <span>823ms</span>
                <span>↑ 8t</span>
                <span>↓ 18t</span>
          ...
          <div className="bg-white rounded-lg shadow flex flex-col">
            ...
            <div className="p-3 flex items-center justify-center text-xs text-gray-500 mt-auto">
              <div className="flex items-center gap-2">
                <span>873ms</span>
                <span>↑ 8t</span>
                <span>↓ 18t</span>
        ...
        <div className=" bg-white rounded-lg shadow p-3 sticky bottom-0 md:mx-32 lg:mx-60 ">
          <div className="relative">
            <Textarea placeholder="Chat with your promp..." className="resize-none pr-20 " rows={1} />
